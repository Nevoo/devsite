...
const useImageState = create((set) => ({
    ...
    images: [
        ...
        [
            { url: gallery("02799", "weddings"), scale: [3, 2, 0] },
            { url: gallery("02640", "weddings"), scale: [3, 2, 0] },
            { url: gallery("02729", "weddings"), scale: [2, 3, 0] },
            { url: gallery("02936", "weddings"), scale: [2, 3, 0] },
            { url: gallery("02847", "weddings"), scale: [2, 3, 0] },
            { url: gallery("02597", "weddings"), scale: [3, 2, 0] },
        ], // weddings
    ],
